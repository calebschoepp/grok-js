...
- VSCode Plugin (codeLens, installing, icon)
- LSP client (communicating with server and callbacks) 
- LSP server (lsp updates, highlighting) -> return text
- Algorithm (string in, highlighted, TS enum)